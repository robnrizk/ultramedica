<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/MainForm.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<WebUltraMedica.Models.RONTGEN>>" %>
    ...
    <table class="tableblue  tablesorter sortable tablesorterFilters">
        ...
        <tbody class="">
            ...
            <tr>
                ...
                <td>
                    <%if ((roles.Any(m => m.Equals("Admin"))) || roles.Any(m => m.Equals("Rontgen")))
                      { %>
